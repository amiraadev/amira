  ...
  return (
    <div className=' bg-gray-900 h-full w-full '>
        <div className="flex flex-col md:gap-16 p-5">
           <h1 className=''>I can help you with ...</h1>
            <div className="w-full flex flex-col-reverse md:flex-row md:gap-10"> 
            {/* frontend */}
                 <div className="w-1/4 p-4">
                    <FaCode className="icon"/>
                    <hr className=" border-t-2 border-gray-500 md:my-4 "/>
                    <h2 className='font-serif text-4xl text-left md:my-8 text-gray-500'>Frontend </h2>
            ...
            {/* Backend */}
                 <div className="w-1/4 p-4">
                    ...
                    <hr className=" border-t-2 border-gray-500 md:my-4 "/>
                    <h2 className='font-serif text-4xl text-left md:my-8 text-gray-500'>Backend </h2>
                    <div className="text-box ">
            ...
            {/* Database */}
                 <div className="w-1/4 p-4">
                    ...
                    <hr className=" border-t-2 border-gray-500 md:my-4 "/>
                    <h2 className='font-serif text-4xl text-left md:my-8 text-gray-500'>Database </h2>
                    <div className="text-box ">
            ...
            {/* DevOps */}
                 <div className="w-1/4 p-4">
                    ...
                    <hr className=" border-t-2 border-gray-500 md:my-4 "/>
                    <h2 className='font-serif text-4xl text-left md:my-8 text-gray-500'>DevOps </h2>
                    <div className="text-box ">
